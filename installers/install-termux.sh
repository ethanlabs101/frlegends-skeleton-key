...
NPM_CACHE_DIR="$DEBIAN_APP_DIR/.npm-cache"
...
printf "\n[*] Upgrading npm to the supported npm 11 release line...\n"
...
case "$(npm --version)" in
    11.*)
        printf "[+] npm 11 detected successfully.\n"
        ;;
    *)
        printf "[!] npm 11 installation could not be verified.\n"
        exit 1
        ;;
esac
'
...
case \"\$(npm --version)\" in
    11.*)
        ;;
    *)
        printf '[!] npm 11 is required for the Termux installer.\n'
        exit 1
        ;;
esac
